...
class QuestionModelTests(TestCase):
    ...
    def setUp(self):
        self.question = Question(question_text="¿Quien es el mejor Couse Director de platzi?")
    ...
    def test_was_publish_recently_with_present_questions(self):
        """was_published_recently return True for question whose pub_date is in the present"""
        time = timezone.now()
        self.question.pub_date = time
...
def create_question(question_text, days):
    ...
    number of days offset to now(megative for questions publishd in the past,
